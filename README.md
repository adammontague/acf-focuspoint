...
This is my attempt to keep the plugin usable since the original was abandoned.
...
See [`changelog.md`](https://github.com/adammontague/acf-focuspoint/blob/main/changelog.md)
